...
class ViTExtractor(nn.Module):
    ...
    def __init__(self, model_type: str = 'dino_vitb16', stride: int = 4, load_dir: str = "/ibex/user/thagafhh/data/dreamsim_data/models",
                 device: str = 'cuda'):
        """
    ...
    def create_model(model_type: str, load_dir: str = "./models") -> nn.Module:
        ...
        if 'dinov2' in model_type:
            ...
            elif model_type == 'open_clip_vith14':
                model = load_open_clip_as_dino(14, load_dir, h14=True)
            else:
