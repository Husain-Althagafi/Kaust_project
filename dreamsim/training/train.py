...
def parse_args():
    ...
    parser.add_argument('--model_type', type=str, default='dino_vitb16',
                        help='Which ViT model to finetune. To finetune an ensemble of models, pass a comma-separated'
                             ...
                             'open_clip_vitb16, open_clip_vitb32, open_clip_vitl14, open_clip_vith14]')
...
class LightningPerceptualModel(pl.LightningModule):
    ...
    def on_validation_epoch_end(self):
        ...
        self.log(f'val_acc_ckpt', score, logger=True)
        self.log(f'val_loss_ckpt', loss, logger=True)
    ...
    def load_lora_weights(self, checkpoint_root, epoch_load=9):
