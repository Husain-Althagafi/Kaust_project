...
dreamsim_path = '/home/thagafhh/work/dreamsim/dreamsim/dreamsim'
...
def parse_args():
    ...
    parser.add_argument('--load_dir', type=str, default="/ibex/user/thagafhh/data/dreamsim_data/models", help='path to pretrained ViT checkpoints.')
