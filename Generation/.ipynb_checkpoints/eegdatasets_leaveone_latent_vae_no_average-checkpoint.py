...
class EEGDataset():
    ...
    def __init__(self, data_path, exclude_subject=None, subjects=None, train=True, time_window=[0, 1.0], classes = None, pictures = None):
        ...
        if self.classes is None and self.pictures is None:
            ...
            features_filename = os.path.join(f'/ibex/user/thagafhh/data/train_image_latent_512.pt.pt') if self.train else os.path.join(f'/ibex/user/thagafhh/data/test_image_latent_512.pt')
