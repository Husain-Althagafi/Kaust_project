...
def main():
    ...
    parser.add_argument('--data_path', type=str, default='/ibex/user/thagafhh/data/Preprocessed_data_250Hz', help='Path to data')
    parser.add_argument('--output_dir', type=str, default='/ibex/user/thagafhh/data/outputs/contrast/vae', help='Directory to save output results')
    parser.add_argument('--project', type=str, default='vae training', help='Project name for logging')
    ...
    parser.add_argument('--name', type=str, default="vae train inital try", help='Experiment name')
